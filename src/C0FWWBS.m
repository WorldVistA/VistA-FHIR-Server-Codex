C0FWWBS ; VEHU/Codex - C0FW WriteBack save graph API ;May 09, 2026
 ;;0.1;C0FHIR PROJECT;;May 09, 2026
 ;
 ; Stores reminder writeback POST attempts in the active site graph backend.
 ; These are review artifacts, not clinical imports.
 ;
 Q
 ;
...
WSARCH(ARGS,BODY,RESULT) ; POST /writebacksaves/{id}/archive
 ...
 ;
ROOT() ; $$ - graph root
 Q $$ROOT^C0FWGRT("reminder-writeback-saves")
 ;
