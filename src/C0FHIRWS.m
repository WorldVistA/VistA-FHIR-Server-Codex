...
BROWSER(RTN,DFN) ; Interactive FHIR browser (TJSON: /filesystem/tjson.js + tjson_bg.* + tjson_bg.wasm.b64 in M user www)
 ...
 D ADDLN(.RTN,"const TJSON_PKG=location.origin+'/filesystem/tjson.js?v=043';")
 ...
 D ADDLN(.RTN,"  el('detail').textContent=(typeof m.fromJson==='function'?m.fromJson(js,{}):m.stringify(obj,{}));")
