...
BROWSER(RTN,FILTER) ; Interactive FHIR browser for live /fhir or stored /showfhir bundles
 ...
 . D ADDLN(.RTN,"<button type='button' id='qualityAnalyze'>Analyze</button><button type='button' id='qualitySave' disabled>Save Review</button></div>")
 . D ADDLN(.RTN,"<div id='qualityStatus' class='quality-status'>Analyze this patient for quality pick-list actions.</div>")
