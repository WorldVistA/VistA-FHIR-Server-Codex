...
| `ckd-stage-3` | Chronic kidney disease stage 3 | ICD-10 `N18.30`; SNOMED CT `433144002` Chronic kidney disease stage 3 | `433144002` Chronic kidney disease stage 3; `84229001` Fatigue; `6408001` Nocturia; optional `271809000` Peripheral edema | CKD stage 3 can be V POV/Condition; symptoms file as standard codes. |
...
| `gout-flare` | Acute gout flare | ICD-10 `M10.9`; SNOMED CT `770924008` Acute gout | `770924008` Acute gout; `67148009` Podagra; `247441003` Erythema of joint; `271771009` Joint swelling | Gout can be V POV/Condition; flare findings file as standard codes. |
