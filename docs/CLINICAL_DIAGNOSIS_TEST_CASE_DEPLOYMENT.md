...
| --- | --- | --- | --- | --- |
| `htn-basic` | Essential hypertension | ICD-10 `I10`; SNOMED CT `38341003` Essential hypertension | `38341003` Essential hypertension; `1332487002` Finding of elevated blood pressure; optional `279029000` Occipital headache | Hypertension can be mapped as the V POV/Condition; elevated BP and headache should also file as encounter standard codes. |
...
| `cap-acute` | Community-acquired pneumonia | ICD-10 `J18.9`; SNOMED CT `1255624009` Community acquired pneumonia | `1255624009` Community acquired pneumonia; `386661006` Fever; `267036007` Dyspnea; `252125005` Pulmonary infiltrate | Pneumonia diagnosis should be verified locally; findings file as standard codes. |
| `hypothyroid-primary` | Hypothyroidism | ICD-10 `E03.9`; SNOMED CT `40930008` Hypothyroidism | `40930008` Hypothyroidism; `1234833005` Lethargy; `262285001` Weight gain; `274640006` Intolerance to cold | Diagnosis can be V POV/Condition if local mapping resolves; findings file as standard codes. |
| `cystitis-acute` | Acute cystitis | ICD-10 `N30.00`; SNOMED CT `197927001` Acute cystitis | `197927001` Acute cystitis; `4783008` Dysuria; `162116003` Urinary frequency; `274332007` Suprapubic pain | Acute cystitis should be verified locally; urinary symptoms file as standard codes. |
| `hyperlipidemia-basic` | Hyperlipidemia | ICD-10 `E78.5`; SNOMED CT `55822004` Hyperlipidemia | `55822004` Hyperlipidemia; `102613006` Asymptomatic; optional cholesterol-related finding if terminology search returns one | Diagnosis can be V POV/Condition; avoid over-modeling lipid lab results until Stage 2. |
| `copd-basic` | COPD | ICD-10 `J44.9`; SNOMED CT `13645005` Chronic obstructive lung disease | `13645005` Chronic obstructive lung disease; `68154008` Chronic cough; `271615008` Chronic sputum production; `6142004` Exertional dyspnea | COPD can be V POV/Condition; respiratory manifestations file as standard codes. |
...
| `appendicitis-acute` | Acute appendicitis | ICD-10 `K35.80`; SNOMED CT `85189001` Acute appendicitis | `85189001` Acute appendicitis; `285370001` Abdominal pain localized to right iliac fossa; `247348006` Abdominal tenderness | Diagnosis can be V POV/Condition; localized findings file as standard codes. |
| `ckd-stage-3` | Chronic kidney disease stage 3 | ICD-10 `N18.30`; SNOMED CT `431162002` Chronic kidney disease stage 3 | `431162002` Chronic kidney disease stage 3; `84229001` Fatigue; `56515002` Nocturia; optional `52612005` Peripheral edema | CKD stage 3 can be V POV/Condition; symptoms file as standard codes. |
| `mdd-recurrent-moderate` | Major depressive disorder, recurrent, moderate | ICD-10 `F33.1`; SNOMED CT `371516004` Major depressive disorder, recurrent, moderate | `371516004` Major depressive disorder, recurrent, moderate; `21134002` Depressed mood; `193462001` Insomnia; `79614002` Anhedonia | Diagnosis mapping should be verified locally; symptoms file as standard codes. |
| `gout-flare` | Acute gout flare | ICD-10 `M10.9`; SNOMED CT `15637000` Gout | `15637000` Gout; `299307005` Podagra; `247441003` Erythema of joint; `299321008` Joint swelling | Gout can be V POV/Condition; flare findings file as standard codes. |
